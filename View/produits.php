    ...
    <body>
        ...
        <div class="contenu">
            <h1 class="titre_page">Nos produits</h1>
                <button class="search_button" onclick="openTri()">Recherche</button>
                    <div class="colonnes_container">
                        <div class="colonne_tri" id="popupTri">
                            <button class="close_button" onclick="closeTri()"><span>X</span></button>
                            <!-- Boutons de tri + requêtage -->
                                 <?php
                                    ...
                                    <form method="get">
                                        ...
                                        <br>
                                        <button class="lancer_recherche" type="submit" onclick="closeTri()">Lancer la recherche</button>
                                    </form>
                        </div>
