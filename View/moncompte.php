...
<div class="contenu p-5">
    ...
    <form class="row g-3" action="moncompte.php" method="post">
        ...
        <br>
        <p>Prénom : <?= $selectUserInfo['prenom']?> </p>
        <br>
        <div class="col-md-6">
            <label for="telClient" class="form-label">Numéro de téléphone portable : </label>
            <input type="number" class="form-control" name="telClient" value="<?= $selectUserInfo['telephone_port']?>" id="telClient">
        </div>
        <div class="col-md-6">
            <label for="telFixClient" class="form-label">Numéro de téléphone fixe : </label>
            <input type="number" class="form-control" name="telFixClient" value="<?= $selectUserInfo['telephone_fixe']?>" id="telFixClient">
        </div>
        <div class="col-md-8">
            <label for="mailClient" class="form-label">Adresse mail : </label>
