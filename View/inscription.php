...
if (isset($_POST['submit'])) {
    ...
    if  (isset($_POST['identifiant']) && !empty($_POST['identifiant'])){
        ...
        if (!preg_match('/^[A-Za-z][A-Za-z0-9]{4,31}$/', $_POST['identifiant'])){
            $errors[] = "Votre nom d'utilisateur n'est pas conforme, il doit contenir entre 4 et 31 caractères sans caractères spéciaux";
...
<div class="contenu">
    ...
    <form class="row g-3" action="inscription.php" method="post">
        ...
        <i style="color:dimgrey;"><span style="color:red;">*</span> Champs obligatoires</i>
        <br>
        <br>
